...
public abstract class Block {
	private static Integer[] masks = new Integer[]{0xff000000, 0x00ff0000, 0x0000ff00, 0x000000ff};
		...
		public static class Key extends Block {
		...
		private static abstract class EnDecryptionBlock extends Block {
			public EnDecryptionBlock(byte[] bytes) {
				super(bytes);
			}
		...
		public static class EncryptionBlock extends EnDecryptionBlock {	
		...
		public static class DecryptionBlock extends EnDecryptionBlock {
			...
			private int OFRightShift(int DWORD, int bits) {
				return (DWORD >>> bits) | (DWORD << 32 - bits);
			}
		}
}
